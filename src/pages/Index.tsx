...
const Index = () => {
  ...
  const products: Product[] = [
    {
      id: 1,
      name: "Морилка для дерева BORMA WACHS",
      price: 890,
      oldPrice: 1100,
      category: "Морилки",
      image: "/img/259f05f5-e4dd-4caf-a57b-b098b5b43ca4.jpg",
      description: "Профессиональная морилка на водной основе для глубокого проникновения в древесину",
      instructions: [
        "Очистите поверхность от пыли и старых покрытий",
        "Нанесите морилку кистью вдоль волокон дерева",
        "Дайте высохнуть 2-4 часа при комнатной температуре",
        "При необходимости нанесите второй слой"
      ],
      features: ["Быстрое высыхание", "Глубокое проникновение", "Экологически чистая"]
    },
    {
      id: 2,
      name: "Лак BORMA HOLZLACK глянцевый",
      price: 1250,
      category: "Лаки",
      image: "/img/b090ec4c-5d96-42ad-8246-cc69c45f803d.jpg",
      description: "Высококачественный полиуретановый лак с превосходной защитой от износа",
      instructions: [
        "Подготовьте поверхность шлифовкой зерном 220",
        "Удалите пыль сухой тканью",
        "Нанесите тонкий слой кистью или валиком",
        "Промежуточная шлифовка между слоями зерном 320",
        "Нанесите 2-3 слоя для оптимального результата"
      ],
      features: ["Высокая износостойкость", "UV защита", "Быстрое высыхание"]
    },
    {
      id: 3,
      name: "Грунтовка BORMA PRIMER универсальная",
      price: 780,
      category: "Грунтовки",
      image: "/img/259f05f5-e4dd-4caf-a57b-b098b5b43ca4.jpg",
      description: "Универсальная грунтовка для подготовки древесины под финишное покрытие",
      instructions: [
        "Очистите поверхность от грязи и жира",
        "Нанесите грунтовку равномерным слоем",
        "Время высыхания 1-2 часа",
        "Слегка отшлифуйте перед нанесением финишного покрытия"
      ],
      features: ["Отличная адгезия", "Быстрая сушка", "Универсальность применения"]
    }
  ];
